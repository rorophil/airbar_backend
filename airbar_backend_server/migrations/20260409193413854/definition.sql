...
--
-- Class ProductPortion as table product_portions
--
...
CREATE TABLE "products" (
    ...
    "currentUnitRemaining" double precision,
    "imageUrl" text,
    "isActive" boolean NOT NULL DEFAULT true,
    "isDeleted" boolean NOT NULL DEFAULT false,
    "trackStock" boolean NOT NULL DEFAULT true,
    "isBulkProduct" boolean NOT NULL DEFAULT false,
    "bulkUnit" text,
    "bulkTotalQuantity" double precision,
    "createdAt" timestamp without time zone NOT NULL,
    "updatedAt" timestamp without time zone NOT NULL
);
...
--
-- Class StockMovement as table stock_movements
--
...
--
-- Class TransactionItem as table transaction_items
--
CREATE TABLE "transaction_items" (
    ...
    "stockDeduction" double precision DEFAULT 0
);
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('airbar_backend', '20260409193413854', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260409193413854', "timestamp" = now();
