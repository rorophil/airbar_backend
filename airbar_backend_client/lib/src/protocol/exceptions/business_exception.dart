...
abstract class BusinessException
  ...
  factory BusinessException.fromJson(Map<String, dynamic> jsonSerialization) {
    return BusinessException(message: jsonSerialization['message'] as String);
  }
  ...
  Map<String, dynamic> toJson() {
    return {
      '__className__': 'BusinessException',
      'message': message,
    };
  }
...
class _BusinessExceptionImpl extends BusinessException {
  _BusinessExceptionImpl({required String message}) : super._(message: message);
